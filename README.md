...
- Run the below commands and can see results in / from Output.md
  ```sh
  % chmod +x DocChecker.sh
  % ./DocChecker.sh Test.md Output.md

# NewDocChecker

#### This script can be used to find duplicate questions in a .md file for FAQs with specific keywords.
...
- Run the below commands and can see results in / from Output.md
  ```sh
  % chmod +x NewDocChecker.sh
  % ./NewDocChecker.sh Test.txt
  %  Enter the keyword to search for : <your-input-value-keyword>
